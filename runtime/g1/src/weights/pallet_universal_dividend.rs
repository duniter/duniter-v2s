...
impl<T: frame_system::Config> pallet_universal_dividend::WeightInfo for WeightInfo<T> {
	...
	fn claim_uds(i: u32, ) -> Weight {
		...
		Weight::from_parts(34_059_574, 0)
			.saturating_add(Weight::from_parts(0, 4141))
			// Standard Error: 825
			.saturating_add(Weight::from_parts(6_192, 0).saturating_mul(i.into()))
	...
	fn transfer_ud() -> Weight {
		...
		//  Measured:  `156`
		//  Estimated: `6126`
		// Minimum execution time: 48_313_000 picoseconds.
		Weight::from_parts(51_558_000, 0)
	...
	fn transfer_ud_keep_alive() -> Weight {
		...
		Weight::from_parts(33_601_000, 0)
	...
	fn on_removed_member(i: u32, ) -> Weight {
		...
		Weight::from_parts(20_313_605, 0)
			.saturating_add(Weight::from_parts(0, 3558))
			// Standard Error: 349
			.saturating_add(Weight::from_parts(88, 0).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
