...
impl<T: frame_system::Config> pallet_quota::WeightInfo for WeightInfo<T> {
	...
	fn queue_refund() -> Weight {
		...
		//  Measured:  `11288`
		//  Estimated: `12751`
		// Minimum execution time: 68_111_000 picoseconds.
		Weight::from_parts(69_944_000, 0)
	...
	fn spend_quota() -> Weight {
		...
		//  Measured:  `172`
		//  Estimated: `3489`
		// Minimum execution time: 43_445_000 picoseconds.
	...
	fn try_refund() -> Weight {
		...
		//  Measured:  `235`
		//  Estimated: `6126`
		// Minimum execution time: 181_574_000 picoseconds.
		Weight::from_parts(187_852_000, 0)
	...
	fn do_refund() -> Weight {
		...
		//  Measured:  `235`
		//  Estimated: `6126`
		// Minimum execution time: 181_093_000 picoseconds.
		Weight::from_parts(183_222_000, 0)
			.saturating_add(Weight::from_parts(0, 6126))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	...
	fn on_process_refund_queue_elements(i: u32, ) -> Weight {
		...
		//  Measured:  `260 + i * (44 ±0)`
		//  Estimated: `12751`
		// Minimum execution time: 198_778_000 picoseconds.
		Weight::from_parts(297_822_321, 0)
			.saturating_add(Weight::from_parts(0, 12751))
			// Standard Error: 12_633
			.saturating_add(Weight::from_parts(9_833_106, 0).saturating_mul(i.into()))
