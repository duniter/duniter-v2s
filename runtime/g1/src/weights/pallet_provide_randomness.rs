...
impl<T: frame_system::Config> pallet_provide_randomness::WeightInfo for WeightInfo<T> {
	fn request() -> Weight {
		...
		//  Measured:  `298`
		//  Estimated: `0`
		// Minimum execution time: 134_956_000 picoseconds.
		Weight::from_parts(151_531_000, 0)
	...
	fn on_initialize(i: u32, ) -> Weight {
		...
		Weight::from_parts(109_995_098, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 434_066
			.saturating_add(Weight::from_parts(20_149_947, 0).saturating_mul(i.into()))
	}
	/// The range of component `i` is `[1, 100]`.
	fn on_initialize_epoch(i: u32, ) -> Weight {
		...
		//  Measured:  `351 + i * (59 ±0)`
		//  Estimated: `0`
		// Minimum execution time: 112_383_000 picoseconds.
		Weight::from_parts(131_643_167, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 232_975
			.saturating_add(Weight::from_parts(19_663_288, 0).saturating_mul(i.into()))
	}
}
