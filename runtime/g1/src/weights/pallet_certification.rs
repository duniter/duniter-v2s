...
impl<T: frame_system::Config> pallet_certification::WeightInfo for WeightInfo<T> {
	...
	fn add_cert() -> Weight {
		...
		Weight::from_parts(40_368_000, 0)
	...
	fn renew_cert() -> Weight {
		...
		Weight::from_parts(36_871_000, 0)
	...
	fn del_cert() -> Weight {
		...
		//  Measured:  `2174`
		//  Estimated: `15539`
		// Minimum execution time: 119_495_000 picoseconds.
		Weight::from_parts(124_716_000, 0)
	...
	fn remove_all_certs_received_by(i: u32, ) -> Weight {
		...
		Weight::from_parts(34_788_727, 0)
			.saturating_add(Weight::from_parts(0, 4049))
			// Standard Error: 9_113
			.saturating_add(Weight::from_parts(4_228_996, 0).saturating_mul(i.into()))
	...
	fn do_remove_all_certs_received_by(i: u32, ) -> Weight {
		...
		Weight::from_parts(18_512_070, 0)
			.saturating_add(Weight::from_parts(0, 4016))
			// Standard Error: 9_297
			.saturating_add(Weight::from_parts(3_896_695, 0).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(i.into())))
			.saturating_add(T::DbWeight::get().writes(1))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
