...
impl<T: frame_system::Config> pallet_provide_randomness::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(i: u32, ) -> Weight {
		...
		Weight::from_parts(16_766_527, 0)
			.saturating_add(Weight::from_parts(0, 1827))
			// Standard Error: 9_838
			.saturating_add(Weight::from_parts(5_249_762, 0).saturating_mul(i.into()))
	...
	fn on_initialize_epoch(i: u32, ) -> Weight {
		...
		Weight::from_parts(17_241_363, 0)
			.saturating_add(Weight::from_parts(0, 3817))
			// Standard Error: 7_280
			.saturating_add(Weight::from_parts(5_616_684, 0).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().reads(7))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(i.into())))
			.saturating_add(T::DbWeight::get().writes(3))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
