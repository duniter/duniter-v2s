...
impl<T: frame_system::Config> pallet_certification::WeightInfo for WeightInfo<T> {
	...
	fn add_cert() -> Weight {
		...
		Weight::from_parts(40_471_000, 0)
	...
	fn del_cert() -> Weight {
		...
		//  Measured:  `2174`
		//  Estimated: `15539`
		// Minimum execution time: 118_755_000 picoseconds.
		Weight::from_parts(125_199_000, 0)
	...
	fn remove_all_certs_received_by(i: u32, ) -> Weight {
		...
		Weight::from_parts(1_851_632, 0)
			.saturating_add(Weight::from_parts(0, 4049))
			// Standard Error: 3_443
			.saturating_add(Weight::from_parts(4_284_707, 0).saturating_mul(i.into()))
	...
	fn do_remove_cert() -> Weight {
		...
		Weight::from_parts(23_889_000, 0)
	...
	fn do_remove_all_certs_received_by(i: u32, ) -> Weight {
		...
		Weight::from_parts(21_572_517, 0)
			.saturating_add(Weight::from_parts(0, 4016))
			// Standard Error: 4_382
			.saturating_add(Weight::from_parts(3_855_786, 0).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(i.into())))
			.saturating_add(T::DbWeight::get().writes(1))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
