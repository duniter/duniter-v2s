...
impl<T: frame_system::Config> pallet_quota::WeightInfo for WeightInfo<T> {
	...
	fn try_refund() -> Weight {
		...
		//  Measured:  `235`
		//  Estimated: `0`
		// Minimum execution time: 77_283_000 picoseconds.
		Weight::from_parts(80_467_000, 0)
			.saturating_add(Weight::from_parts(0, 0))
	}
	fn do_refund() -> Weight {
		// Proof Size summary in bytes:
		...
		Weight::from_parts(80_957_000, 0)
			.saturating_add(Weight::from_parts(0, 0))
	}
	...
	fn on_process_refund_queue_elements(i: u32, ) -> Weight {
		...
		Weight::from_parts(239_817_285, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 108_762
			.saturating_add(Weight::from_parts(4_351_254, 0).saturating_mul(i.into()))
	}
}
