...
impl<T: frame_system::Config> pallet_universal_dividend::WeightInfo for WeightInfo<T> {
	...
	fn claim_uds(i: u32, ) -> Weight {
		...
		//  Measured:  `676`
		//  Estimated: `4141`
		// Minimum execution time: 230_019_000 picoseconds.
		Weight::from_parts(217_765_902, 0)
			.saturating_add(Weight::from_parts(0, 4141))
			// Standard Error: 36_738
			.saturating_add(Weight::from_parts(508_270, 0).saturating_mul(i.into()))
	...
	fn transfer_ud() -> Weight {
		...
		//  Measured:  `156`
		//  Estimated: `6126`
		// Minimum execution time: 389_500_000 picoseconds.
		Weight::from_parts(408_371_000, 0)
	...
	fn transfer_ud_keep_alive() -> Weight {
		...
		//  Measured:  `93`
		//  Estimated: `3558`
		// Minimum execution time: 242_778_000 picoseconds.
		Weight::from_parts(246_963_000, 0)
	...
	fn on_removed_member(i: u32, ) -> Weight {
		...
		//  Measured:  `181`
		//  Estimated: `3558`
		// Minimum execution time: 134_962_000 picoseconds.
		Weight::from_parts(136_944_325, 0)
			.saturating_add(Weight::from_parts(0, 3558))
			// Standard Error: 34_427
			.saturating_add(Weight::from_parts(188_377, 0).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
