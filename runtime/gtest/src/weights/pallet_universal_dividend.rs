...
impl<T: frame_system::Config> pallet_universal_dividend::WeightInfo for WeightInfo<T> {
	...
	fn claim_uds(_i: u32, ) -> Weight {
		...
		//  Measured:  `676`
		//  Estimated: `0`
		// Minimum execution time: 102_652_000 picoseconds.
		Weight::from_parts(151_105_318, 0)
	...
	fn transfer_ud() -> Weight {
		...
		//  Measured:  `156`
		//  Estimated: `0`
		// Minimum execution time: 170_510_000 picoseconds.
		Weight::from_parts(183_944_000, 0)
			.saturating_add(Weight::from_parts(0, 0))
	}
	fn transfer_ud_keep_alive() -> Weight {
		...
		Weight::from_parts(120_192_000, 0)
			.saturating_add(Weight::from_parts(0, 0))
	}
	/// The range of component `i` is `[1, 160]`.
	fn on_removed_member(i: u32, ) -> Weight {
		...
		Weight::from_parts(74_020_230, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 13_645
			.saturating_add(Weight::from_parts(4_550, 0).saturating_mul(i.into()))
	}
}
